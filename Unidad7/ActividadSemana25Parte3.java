...
public class ActividadSemana25Parte3 {
    ...
    System.out.println("Enhorabuena, tu puntuacion total ha sido : " + cont);
        ...
        while (n<=10) {
            ...
            String respuesta6 = entrada.nextLine();
            if (respuesta6.equals(color5)) {
                n++;
            ...
            String respuesta7 = entrada.nextLine();
            if (respuesta7.equals(color4)) {
                n++;
            ...
            String respuesta8 = entrada.nextLine();
            if (respuesta8.equals(color3)) {
                n++;
            ...
            String respuesta9 = entrada.nextLine();
            if (respuesta9.equals(color2)) {
                n++;
            ...
            String respuesta10 = entrada.nextLine();
            if (respuesta10.equals(color1)) {
                n++;
